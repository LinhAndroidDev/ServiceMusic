...
object Data {
    fun listMusic(): ArrayList<Song> {
        return arrayListOf(
            ...
            Song("Âm thầm bên em", "Sơn Tùng MTP", R.drawable.am_tham_ben_em, R.raw.am_tham_ben_em, 292, 0),
            ...
            Song("Một triệu khả năng", "Phùng Đề Mạc", R.drawable.mot_trieu_kha_nang, R.raw.mot_trieu_kha_nang, 275, 1),
